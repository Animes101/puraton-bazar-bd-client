  ...
  return (
    <div className="p-5">
      ...
      <h1 className="text-3xl font-bold mb-5">
        Welcome Back, <span className="text-bg3 uppercase text-4xl">{user?.displayName}</span> 👋
      </h1>

      {/* Top Cards */}
      <div className="grid grid-cols-1 md:grid-cols-2 gap-5 mb-8">
        
        <div className="bg-bg2 border-bg3 shadow-md rounded-lg p-5 border">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
        ...
        {/* Bar Chart */}
        <div className="bg-bg2 border-bg3  shadow-md p-5 rounded-lg border">
